...
class SchoolParent(models.Model):
    ...
    def onchange_student_id(self):
        ...
        self.stand_id = [(6, 0, [])]
        standard_ids = [student.standard_id.id for student in self.student_id]
        if standard_ids:
            stand_ids = [
                student.standard_id.standard_id.id
    ...
    teacher_id = fields.Many2one(
        "school.teacher", "Teacher", related="standard_id.user_id", store=True
    )
